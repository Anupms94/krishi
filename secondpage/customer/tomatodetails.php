...
<body>
                    ...
                    <div id="nav-search">
                        <form method="POST" action="search.php">
                            <div class="nav-left">
                                ...
                                <!--               <form id="frmSearch" class="search" method="get" action="hometry.html" >
        --> <input class="search" type="hidden" name="sitesearch" value="hometry.html" />
                            </div>
                            <div class="nav-right">
    ...
    <div class="small-container product-details">
        <div class="row">
            <div class="col-2">
                <img src="../images/tomato1.png" width="100%" id="ProductImg">
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="../images/tomato1.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/tomato2.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/tomato3.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/tomato4.png" width="100%" class="small-img">
                    </div>
                </div>
            </div>
            <div class="col-2">
                <p>Home /Products/Vegetables/ Tomato</p>
                <h1>Tomato</h1>
                <div class="rating">
                ...
                <div id="site">
                    <!---->
                    <div class="product-description" data-name="Tomato" data-price="40">
                ...
                <p>
                    <br>
                    The tomato is the edible, often red berry of the plant Solanum lycopersicum,[1][2] commonly known as
                    a tomato plant. The species originated in western South America and Central America.[2][3] The
                    Nahuatl (the language used by the Aztecs) word tomatl gave rise to the Spanish word tomate, from
                    which the English word tomato derived.[3][4] Its domestication and use as a cultivated food may have
                    originated with the indigenous peoples of Mexico.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="small-container">
        ...
        <div class="row">
            ...
            <div class="col-4">
                <a href="grapesdetails.php"><img src="../images/grapes.jpg"></a>
                <h4><b>Grapes</b></h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <a href="kiwidetails.php"><img src="../images/kiwi.jpg"></a>
                <h4><b>kiwi</b></h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>

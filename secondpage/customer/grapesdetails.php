...
<body>
    ...
    <div class="small-container product-details">
        <div class="row">
            <div class="col-2">
                <img src="../images/grapes3.png" width="100%" id="ProductImg">
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="../images/grapes1.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/grapes2.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/grapes3.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/grapes4.png" width="100%" class="small-img">
                    </div>
                </div>
            </div>
            <div class="col-2">
                <p>Home /Products/Fruits/ Grapes</p>
                <h1>Onion</h1>
                <div class="rating">
                ...
                <div id="site">
                    <!---->
                    <div class="product-description" data-name="Grapes" data-price="70">
                        <p class="product-price">
                        <h4><del>Rs 100</del> Rs 70</h4>
                        </p>
                ...
                <p>
                    <br>
                    Grapes contain powerful antioxidants known as polyphenols. These are thought to have
                    anti-inflammatory and antioxidant properties. One of these is resveratrol. It is found in the skins
                    of red grapes.
                    Laboratory studies have suggested that resveratrol may be able to slow or prevent the growth of
                    tumors in lymph, liver, stomach, breast, colon, skin cancer, and leukemia.
                </p>
            </div>
        </div>
    </div>

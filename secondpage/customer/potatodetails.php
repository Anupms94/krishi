...
<body>
    ...
    <div class="small-container product-details">
        <div class="row">
            <div class="col-2">
                <img src="../images/potato.png" width="100%" id="ProductImg">
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="../images/potato1.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/potato2.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/potato3.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/potato4.png" width="100%" class="small-img">
                    </div>
                </div>
            </div>
            <div class="col-2">
                <p>Home /Products/Vegetables/ Potato</p> <!-- Change-->
                <h1>Potato</h1>
                <div class="rating">
                ...
                <div id="site">
                    <!---->
                    <div class="product-description" data-name="Potato" data-price="30">
                        <p class="product-price">
                        <h4><del>Rs 50</del> Rs 30</h4>
                        </p>
                ...
                <p>
                    <br>
                    The potato is a root vegetable native to the Americas, a starchy tuber of the plant Solanum
                    tuberosum, and the plant itself is a perennial in the nightshade family, Solanaceae. Wild potato
                    species, originating in modern-day Peru, can be found throughout the Americas, from the United
                    States to southern Chile.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="small-container">
        ...
        <div class="row">
            <div class="col-4">
                <a href="productdetails.php"><img src="../images/mango.png"></a>
                <h4><b>Mango</b></h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <a href="oniondetails.php"><img src="../images/onion1.png"></a>
                <h4><b>Onion</b></h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <a href="grapesdetails.php"><img src="../images/grapes2.png"></a>
                <h4><b>Grapes</b></h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <a href="kiwidetails.php"><img src="../images/kiwi1.png"></a>
                <h4><b>kiwi</b></h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
